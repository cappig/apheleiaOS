...
#define FLAGS_MASK                                                                                                    \
    (PT_PRESENT | PT_READ | PT_WRITE | PT_EXECUTE | PT_USER | PT_GLOBAL | PT_ACCESSED | PT_DIRTY | PT_WRITE_THROUGH | \
     PT_NO_CACHE | PT_HUGE | PT_NO_EXECUTE)
#else
...
#define FLAGS_MASK (PT_PRESENT | PT_READ | PT_WRITE | PT_EXECUTE | PT_USER | PT_GLOBAL | PT_ACCESSED | PT_DIRTY)
#endif
