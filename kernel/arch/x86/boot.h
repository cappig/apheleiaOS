...
#define APIC_MMIO_BASE_32   0xfec00000UL

#define KSTACK_REGION_TOP_32  ((APIC_MMIO_BASE_32 < PHYS_WINDOW_BASE_32) ? APIC_MMIO_BASE_32 : PHYS_WINDOW_BASE_32)
#define KSTACK_REGION_SIZE_32 (128 * MIB)
#define KSTACK_REGION_BASE_32 (KSTACK_REGION_TOP_32 - KSTACK_REGION_SIZE_32)
