...
int main(void) {
    ...
    draw_fill_rect(pixels, window.width, window.height, 0, 0, window.width, window.height, 0x00141414U);
    ...
    draw_fill_polygon(pixels, window.width, window.height, triangle, 3, 0x0000ff00U);
